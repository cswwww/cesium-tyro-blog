 ...
 * @LastEditTime: 2023-07-28 15:41:22
...
<template>
  <el-tooltip :content="flag ? '点击开启影像卷帘' : '再次点击关闭卷帘'" placement="bottom" effect="light">
    <el-button circle @click="action"><svg t="1690529118818" class="icon" viewBox="0 0 1024 1024" version="1.1"
        xmlns="http://www.w3.org/2000/svg" p-id="13818" width="20" height="20">
