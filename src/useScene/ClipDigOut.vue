 ...
 * @LastEditTime: 2023-09-30 15:13:51
 * @FilePath: \cesium-tyro-blog\src\useScene\ClipDigOut.vue
 * @Description: 组件
-->
<script setup>
import { ref } from 'vue'
    ...
    <div style="text-align: center;">
      <svg t="1696056449962" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <path d="M512 256l416 208L512 672 96 464 512 256z m0.832 87.232L288 464l224 112 224-112-223.168-120.768z"
          fill="#1296db" p-id="13680"></path>
      </svg>
    </div>
    <div style="text-align: center;">{{ flag ? '地形裁剪挖出' : '关闭地形裁剪' }}</div>
  </el-card>
</template>
